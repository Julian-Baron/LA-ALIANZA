                                    ...
                                    <ul class="navbar-nav">
                                      <li class="nav-item dropdown">
                                          ...
                                          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                            ...
                                            <li><form action='cerrar_sesion' method="post"><button name="terminar"><a class="dropdown-item nav-link" href="Formulario_Comprador.jsp">Cerrar sesion</a></button></form></li>
                                          </ul>
                                        </li>                                               
                                    <li class="nav-item">
                                      <a class="nav-link active" aria-current="page" href="Formulario_Comprador.jsp"></a>
